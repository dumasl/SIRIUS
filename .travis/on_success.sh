if [ "x${TRAVIS_REPO_SLUG}" = "xdumasl/SIRIUS" ]; then
    ...
    docker run -v $TRAVIS_BUILD_DIR:/data ldumas/sirius_dockerfile:sirius_pages /bin/sh -c "cd /data; mv doxy_html doc/sphinx/build/; cd doc/sphinx/build/; cp doxy_html/index.html html/other/cpp_index.html"
